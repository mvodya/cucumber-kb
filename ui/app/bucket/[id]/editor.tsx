    ...
    <form action={formAction}>
      <div className="flex flex-col gap-4">
        <div className="bg-gray-800 rounded-2xl p-4">
          ...
          <button className="float-right rounded-md bg-green-700 hover:bg-green-600 px-3" type="submit"><i className="fa fa-cloud-upload" aria-hidden="true" /> СОХРАНИТЬ</button>
